  ...
  render() {
    ...
    <div className="signin_new_body">
          <div className="container signin_container" id="container">
              ...
              <div className="signin_form-container signin_sign-in-container">
                  <div className="signin_overlay">
                      ...
                      <div className="signin_overlay-panel signin_overlay-right">
                          ...
                          <p className="signin_p">Write down your feeling before challenging the idea and afterward. How did questioning the distorted view change your feelings? 
                      </p>
                      </div>
                  </div>
              </div>
              ...
              <div className="signin_form">
                  <a className="social signin_a"><FontAwesomeIcon icon="bell" size="4x" style={{ color: 'red' }} /></a>
