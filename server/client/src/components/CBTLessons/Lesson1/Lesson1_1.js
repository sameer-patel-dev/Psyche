...
const Lesson1_1 = () => {
    ...
    return (
        ...
        <div className="lessonBody">
            <div>
                <h3>Introduction - What is CBT?</h3>
                <br></br>
                <iframe className="videoLesson" src="https://www.youtube.com/embed/9c_Bv_FBE-c" title="YouTube video player" frameborder="0"   allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>   
                <p>
        ...
        <nav className="footer">
            From, &nbsp; Vivyan, C., 2021. Cognitive Behaviour Therapy. [online] Getselfhelp.co.uk. Available at: &lt;https://www.getselfhelp.co.uk/cbt.htm&gt;  [Accessed 22 April 2021].
        </nav>
