...
const Lesson4_1 = () => {
    ...
    return (
        ...
        <div className="lessonBody">
            <div>
                <h3>Problems, Solutions and Goals - 1</h3>
                <br></br>
                <iframe className="videoLesson" src="https://www.youtube.com/embed/LdQGAnl2jc8" title="YouTube video player" frameborder="0"   allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>   
                <p>
