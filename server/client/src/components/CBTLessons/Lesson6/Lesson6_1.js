...
const Lesson6_1 = () => {
    ...
    return (
        ...
        <div className="lessonBody">
            <div>
                <h3>Dealing with Setbacks - 1</h3>
                <br></br>
                <iframe className="videoLesson" src="https://www.youtube.com/embed/tA7iCb9_YXc" title="YouTube video player" frameborder="0"   allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>   
                <p>
